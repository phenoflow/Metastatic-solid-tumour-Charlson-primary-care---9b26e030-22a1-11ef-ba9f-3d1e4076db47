...
(async () => {
  ...
  await fs.writeFile("metastatic-solid-tumour-charlson-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("metastatic-solid-tumour-charlson-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
